			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-6">
					<div class="banner-content">
						...
						<h1 class="title wow fadeInLeft" data-wow-delay=".5s"> Book your Hostel
							Anywhere, Anytime</h1>

						<span class="promo-tag wow fadeInDown" data-wow-delay=".3s">With Just your smart phone, you can
							book any hostel in navrongo and pay with momo </span>
						<ul>
							<li>
								<Link class="main-btn btn-filled wow fadeInUp" data-wow-delay=".7s" to="/hostel-booking">Get
									Started</Link>
							</li>
					...
					<div class="banner-thumb d-none d-md-block">
						<div class="hero-slider-one">
							<div class="single-thumb">
								<img src={banner01img} height="500" width="100%" alt="images"/>
							</div>
							<div class="single-thumb">
								<img src={banner02img} height="500" width="100%" alt="images"/>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-6">
					<ul class="room-filter nav nav-pills justify-content-center justify-content-lg-end" id="room-tab"
						role="tablist">
						<li class="nav-item">
							<Link class="nav-link active" id="relex-tab" data-bs-toggle="pill" to="#relex">
								Hostels
							</Link>
						</li>
						<li class="nav-item">
							<Link class="nav-link" id="luxury-tab" data-bs-toggle="pill" to="#luxury">
								Rooms
							</Link>
						</li>
							...
							<div class="col-lg-4">
								...
								data-loops="false"/>
									...
									<div class="room-content">
										<h3><Link to="#">Rajnota Residency</Link></h3>
										<span class="room-count"><i class="flaticon-location-pin"></i> 41 Ganesh Nagar 4
											Murlipura, Jaipur</span>
									</div>
									<Link to="#" class="room-link"><i class="fal fa-arrow-right"></i></Link>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="room-box extra-height">
					...
					<div class="room-items">
						<div class="row">
							<div class="col-lg-4">
								<div class="room-box extra-height">
									<div class="room-bg">
										<img src="assets/img/hostel/01.png" alt="" />
									</div>
									<div class="room-content">
										<h3><Link to="#">Rajnota Residency</Link></h3>
										<span class="room-count"><i class="flaticon-location-pin"></i> 41 Ganesh Nagar 4
	...
	<section class="text-block with-bg pt-70 pb-70">
		<div class="container">
			<div class="row align-items-center justify-content-center justify-content-lg-between">
				...
				<div class="col-lg-8 col-md-6 wow fadeInLeft" data-wow-delay=".3s">
					<div class="block-text mb-small pl-20">
						...
						<Link to="/hostel-booking" class="main-btn btn-filled mt-40">Room Booking</Link>
					</div>
				</div>
	...
	<section class="text-block with-bg pt-70 pb-70">
		<div class="container">
			<div class="row align-items-center justify-content-center justify-content-lg-between">
				...
				<div class="col-lg-7 col-md-6 wow fadeInLeft" data-wow-delay=".3s">
					<div class="block-text mb-small pr-20">
						...
						<Link to="/transport-booking" class="main-btn btn-filled mt-40">Transport Booking</Link>
					</div>
				</div>
				<div class="col-lg-5 col-md-6 wow fadeInRight" data-wow-delay=".5s">
					<div class="video-wrap">
	...
	<div class="banner-area bg-light pt-70 pb-70">
		<div class="container">
			<div class="row align-items-center justify-content-center justify-content-lg-between">
				...
				<div class="col-lg-12 col-md-12 text-center wow fadeInLeft" data-wow-delay=".3s">
					<div class="block-text mb-small pl-20">
						<div class="section-title mb-20">
				...
				<div class="col-lg-12 col-md-12 text-center wow fadeInLeft" data-wow-delay=".3s">
					<div class="gallery-loop">
						<div class="single-gallery-image wow fadeInUp" data-wow-delay=".3s">
							<Link to={gallery01img} class="popup-image">
								<img src={gallery01img} alt="Images"/>
							</Link>
						</div>
						<div class="single-gallery-image wow fadeInUp" data-wow-delay=".4s">
							<Link to="assets/img/gallery/02.jpg" class="popup-image">
								<img src={gallery02img}  alt="Images"/>
							</Link>
						</div>
						<div class="single-gallery-image wow fadeInUp" data-wow-delay=".5s">
							<Link to="assets/img/gallery/03.jpg" class="popup-image">
								<img src={gallery03img}  alt="Images"/>
							</Link>
						</div>
						<div class="single-gallery-image wow fadeInUp" data-wow-delay=".6s">
							<Link to="assets/img/gallery/04.jpg" class="popup-image">
								<img src={gallery04img} alt="Images"/>
							</Link>
						</div>
						<div class="single-gallery-image wow fadeInUp" data-wow-delay=".7s">
							<Link to="assets/img/gallery/05.jpg" class="popup-image">
								<img src={gallery05img}  alt="Images"/>
							</Link>
						</div>
						<div class="single-gallery-image wow fadeInUp" data-wow-delay=".8s">
							<Link to="assets/img/gallery/06.jpg" class="popup-image">
								<img src={gallery06img}  alt="Images"/>
							</Link>
						</div>
						<div class="single-gallery-image wow fadeInUp" data-wow-delay=".9s">
							<Link to="assets/img/gallery/07.jpg" class="popup-image">
								<img src={gallery07img}  alt="Images"/>
							</Link>
						</div>
						<div class="single-gallery-image wow fadeInUp" data-wow-delay="1.1s">
							<Link to="assets/img/gallery/08.jpg" class="popup-image">
								<img src={gallery08img}  alt="Images"/>
							</Link>
						</div>
					</div>
				</div>
